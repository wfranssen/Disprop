...
greekDiaDict['lGR'] = makeGrkList('ἃ','ἓ','ἣ','ἳ','ὃ',None,'ὓ','ὣ')
greekDiaDict['uGR'] = makeGrkList('Ἃ','Ἓ','Ἣ','Ἳ','Ὃ',None,'Ὓ','Ὣ')
greekDiaDict['lCR'] = makeGrkList('ἇ',None,'ἧ','ἷ',None,None,'ὗ','ὧ')
...
GREEK_TONOS2OXIA = [[x[0],x[1]] for x in zip('ΏΆάΐΎΌΊΉΈέήίΰόύώ','ΏΆάΐΎΌΊΉΈέήίΰόύώ')]
